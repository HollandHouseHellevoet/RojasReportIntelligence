...
const AGENT_LABEL = 'Rojas Report Intelligence'
const PLACEHOLDER = 'Ask about The Rojas Report, POH intelligence, FAH data, or healthcare policy...'
    ...
    <>
      {!open && (
        <button
          ...
          aria-label="Open intelligence agent"
